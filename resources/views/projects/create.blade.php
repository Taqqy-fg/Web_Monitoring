            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="fw-bold mb-1 text-dark">Tambah Website</h4>
                            <p class="text-muted mb-0 small">Daftarkan website baru untuk mulai dimonitoring secara realtime</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('projects.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group shadow-sm-sm">
                                ...
                                <input type="text" class="form-control border-secondary-subtle border-start-0 ps-0 form-control-lg fs-6" id="name" name="name" value="{{ old('name') }}" required placeholder="Contoh: Toko Online Utama">
                            </div>
                        </div>
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-group shadow-sm-sm">
                                    ...
                                    <input type="url" class="form-control border-secondary-subtle border-start-0 ps-0" id="base_url" name="base_url" value="{{ old('base_url') }}" required placeholder="https://domain.com">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group shadow-sm-sm">
                                    ...
                                    <input type="url" class="form-control border-secondary-subtle border-start-0 ps-0" id="monitor_url" name="monitor_url" value="{{ old('monitor_url') }}" required placeholder="https://domain.com/health">
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control border-secondary-subtle shadow-sm-sm" id="description" name="description" rows="3" placeholder="Catatan tambahan terkait website ini...">{{ old('description') }}</textarea>
                        </div>

                        <div class="mb-5 p-3 bg-light rounded-3 border border-secondary-subtle">
                            <div class="form-check form-switch d-flex align-items-center gap-2 mb-0">
                                <input type="hidden" name="is_active" value="0">
                                <input class="form-check-input mt-0 shadow-sm" type="checkbox" role="switch" id="is_active" name="is_active" value="1" checked style="width: 3em; height: 1.5em; cursor: pointer;">
                            ...
                            <small class="text-muted ms-5 d-block mt-2">Biarkan menyala agar sistem langsung memantau web ini setelah ditambahkan.</small>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            ...
                            <button type="submit" class="btn btn-success px-4 shadow-sm fw-medium">
                                <i class="bi bi-plus-circle me-2"></i>Tambahkan Website
                            </button>
                        </div>
...
<style>
    /* Efek glow biru saat input di-klik */
    .form-control:focus {
        border-color: #198754; 
        box-shadow: none;
    }
